  ...
  return (
    <div className="w-full flex items-center flex-wrap justify-center gap-10">
      <div className="grid gap-4 w-60">
        ...
        <div>
          <h2 className="text-center text-xl text-black font-semibold leading-relaxed pb-1">
            There’s no contact found
          </h2>
          <h2 className="text-center text-[18px] text-black font-normal leading-relaxed pb-1">
